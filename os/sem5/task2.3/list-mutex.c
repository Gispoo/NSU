...
atomic_int inc_count = 0;        // Кол-во нод, идущих по возрастанию
atomic_int inc_iters = 0;        // Кол-во итераций счётчика нод, идущих по возрастанию
atomic_int dec_count = 0;        // Кол-во нод, идущих по убыванию
atomic_int dec_iters = 0;        // Кол-во итераций счётчика нод, идущих по убыванию
atomic_int eq_count = 0;         // Кол-во одинаковых соседних нод
atomic_int eq_iters = 0;         // Кол-во итераций счётчика одинаковых соседних нод
atomic_int swap_count = 0;       // Кол-во свапов
...
int main(int argc, char **argv)
{
	...
	// Итог в одной строке, удобно парсить скриптом
...
// gcc -pthread list-spinlock.c -o spin